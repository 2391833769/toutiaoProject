...
from sqlalchemy import func, DateTime, Integer, String, Index, Text, ForeignKey
...
class Category(Base):
    ...
    sort_order: Mapped[int] = mapped_column(Integer, default=0, nullable=False, comment="分类排序")
